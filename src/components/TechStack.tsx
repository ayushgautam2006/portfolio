...
const techStack = [
  {
    name: "Next.js",
    icon: (
      <svg viewBox="0 0 180 180" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 fill-white">
  ...
  },
  {
    name: "Tailwind",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-[#38B2AC]">
  ...
  },
  {
    name: "Node.js",
    icon: (
      <svg viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-[#339933]">
  ...
  },
  {
    name: "Vercel",
    icon: (
      <svg viewBox="0 0 1155 1000" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-white">
  ...
  },
  {
    name: "GitHub",
    icon: (
      <svg viewBox="0 0 98 96" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-white">
  ...
  },
  {
    name: "VS Code",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-8 h-8 text-[#007ACC]">
...
function TechCard({ tech, index }: { tech: (typeof techStack)[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      whileHover={{
        scale: 1.05,
        boxShadow: "0 0 30px rgba(255,90,0,0.15), 0 20px 40px rgba(0,0,0,0.4)",
      }}
      style={{
      ...
      className="flex flex-col items-center justify-center gap-3 p-6 rounded-2xl bg-[#0A0A0A] border border-white/[0.04] hover:border-accent/[0.2] transition-colors duration-300 cursor-default group"
    >
      <div className="w-12 h-12 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        {tech.icon}
      </div>
      <span className="text-xs font-medium tracking-wide text-[#555] group-hover:text-[#999] transition-colors duration-300">
        {tech.name}
      </span>
    </motion.div>
  );
